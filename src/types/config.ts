...
export function createDefaultConfig(): TailConfig {
  return {
    image: { width: 40, height: 32800, filename: 'mania-noteL' },
    margin: 3,
    throwLength: 100,
    cap: { shape: 'ball', scale: 100, color: { r: 255, g: 255, b: 255, a: 255 }, independentOpacity: false, opacity: 255 },
    body: { fillColor: { r: 255, g: 255, b: 255, a: 255 }, fillOpacity: 255, borderEnabled: false, borderColor: { r: 0, g: 0, b: 0, a: 255 }, borderOpacity: 255, borderWidth: 1 },
    globalOpacity: 255,
  }
}
