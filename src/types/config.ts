...
export interface EffectConfig { capEchoEnabled: boolean; echoColor: RgbaColor; echoOpacity: number; echoLength: number; glowEnabled: boolean; glowColor: RgbaColor; glowOpacity: number; glowDx: number; glowDy: number; glowSize: number; glowSpread: number }
...
export function createDefaultConfig(): TailConfig {
  ...
  return {
    ...
    effect: { capEchoEnabled: false, echoColor: grey, echoOpacity: 76, echoLength: 50, glowEnabled: false, glowColor: { r: 144, g: 238, b: 144, a: 255 }, glowOpacity: 180, glowDx: 0, glowDy: 0, glowSize: 8, glowSpread: 4 },
    globalOpacity: 255,
  }
}
