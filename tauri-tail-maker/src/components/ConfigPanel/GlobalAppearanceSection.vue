<template>
  <section class="config-section">
    ...
    <div class="field">
      ...
      <div class="color-row">
        <ColorPicker v-model:pureColor="colorHex" format="hex" @pureColorChange="debounceApplyHex"
          :disableAlpha="true" />
    ...
    <div class="subsection">
      ...
      <div v-if="config.body.borderEnabled" class="sub-settings fade-in">
        ...
        <div class="color-row">
          <ColorPicker v-model:pureColor="bHex" format="hex" @pureColorChange="debounceApplyBorderHex"
            :disableAlpha="true" />
...
import { rgbaToHex, hexToRgba } from '../../types/config.ts'
