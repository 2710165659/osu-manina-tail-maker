  ...
  <section class="config-section">
    ...
    <div class="field">
      ...
      <div v-if="config.cap.independentSettings" class="sub-settings fade-in">
        ...
        <div class="color-row">
          <ColorPicker v-model:pureColor="capHex" format="hex" @pureColorChange="debounceApplyCapHex"
            :disableAlpha="true" />
...
import { CAP_SHAPE_LABELS, CAP_SHAPE_ORDER, rgbaToHex, hexToRgba, type CapShape } from '../../types/config.ts'
